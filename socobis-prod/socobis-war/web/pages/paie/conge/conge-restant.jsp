...
<%
    try{
        ...
        String libEntete[] = { "id", "nomPersonnel", "matricule", "solde" };
        ...
        pr.setNpp(100);
        pr.setApres("paie/conge/conge-restant.jsp");
...
<div class="content-wrapper">
    <section class="content-header">
        <h1>Liste cong&eacute; restants</h1>
    </section>
    <section class="content">
        ...
        <br>
        <%
            String libEnteteAffiche[] = { "ID Personnel", "Nom Personnel", "Matricule", "Solde"};
            String lienTableau[] = { pr.getLien() + "?but=paie/employe/personnel-fiche.jsp" };
            String colonneLien[] = { "id" };
//            String[] attributLien = {"idPersonnel", "id"};
