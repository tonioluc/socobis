...
<%
    try {
        ...
        paie.setNomTable("PAIE_EDITIONMOISANNEE_LIB_2");
                ...
                <div class="box">
                    ...
                    <div class="row">
                        <div class="col-md-12 box-footer">
                                ...
                                <button style="margin-right: 10px" class="btn btn-tertiary pull-right" id="exportAllBtn">Les bulletins de paies</button>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    const allEmployeesData = [
        ...
        %>
        // NY STRING TSY MAINTSY ANATY '', DIA NY INT NA DOUBLE TSY ATAO ANATY QUOTES
        {
    ...
    function createPayslipHTML(employee) {
        ...
        return '' +
            ...
            '<img src="' + contextPath + '/assets/img/LOGO-512.png" alt="Assurance ARO Logo" onerror="this.style.display=\'none\'; this.nextElementSibling.style.display=\'block\';">' +
            ...
            '<tr><td>Solde :</td><td>' + employee.congeDroit + '</td></tr>' +
            ...
            '<img style="width: 75px; height: 45px" src="' + contextPath + '/assets/img/LOGO-512.png" alt="Assurance ARO Logo" class="footer-logo" onerror="this.style.display=\'none\'; this.nextElementSibling.style.display=\'block\';">' +
