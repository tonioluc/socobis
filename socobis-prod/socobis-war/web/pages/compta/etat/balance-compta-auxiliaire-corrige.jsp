...
<%
    ...
    Balance balance = new Balance(exercice, typeCompte, moisDebut, moisFin, compteDebut, compteFin,true);
...
<meta charset="UTF-8">
<title>Balance des comptes auxiliaires de <%= date1 %> au <%= date2 %></title>
                    ...
                    <div id="table-container">
                        <div class="d-flex align-items-center col-12">
                            <div class="box-header with-border">
                                <h3 class="title">
                                    Balance des comptes auxiliaires du <%= date1 %> au <%= date2 %>
                                </h3>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
