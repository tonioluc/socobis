...
<%
    ...
    String  mapping = "annexe.Poste",
            nomtable = "poste",
            apres = "annexe/poste/poste-fiche.jsp",
            titre = "Modification du poste";
            ...
            <div class="box-fiche">
                <div class="box">
                    <div class="box-title with-border">
                        <h1 class="box-title"><a href=<%= lien + "?but=annexe/poste/poste-fiche.jsp&id="+id%> <i class="fa fa-arrow-circle-left"></i></a><%=pu.getTitre()%></h1>
                    </div>
