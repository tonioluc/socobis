...
<%
    ...
    Personnel  t = new Personnel();
      String  mapping = "personnel.Personnel",
            nomtable = "Personnel",
            apres = "personnel/personnel-fiche.jsp",
            titre = "Modification Personnel";
            ...
            <div class="box-fiche">
                <div class="box">
                    <div class="box-title with-border">
                        <h1 class="box-title"><a href=<%= lien + "?but=Personnel/fiche-Personnel.jsp&id="+id%> <i class="fa fa-arrow-circle-left"></i></a><%=pu.getTitre()%></h1>
                    </div>
