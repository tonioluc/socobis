...
<%
    try {
        ...
        String listeCrt[] = {};
        String listeInt[] = {};
        String libEntete[] = {"id", "designation", "idVenteDetail", "idCaisseLib", "credit"};
...
<div class="box-body">
    <%  String libEnteteAffiche[] = {"id", "d&eacute;signation","Vente d&eacute;tail", "Caisse", "cr&eacute;dit"};
