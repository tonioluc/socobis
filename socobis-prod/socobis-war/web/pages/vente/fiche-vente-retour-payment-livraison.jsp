...
<%
    try {
        ...
        String pageModif = "vente/fiche-vente-retour-payment.jsp";
        String classe = "vente.VenteRetourClient";
        String pageActuel = "vente/fiche-vente-retour-payment.jsp";
                    ...
                    <div class="box-body">
                        ...
                        <div class="box-footer">
                            ...
                            <a class="btn btn-primary pull-right"
                               href="<%= (String) session.getValue("lien") + "?but=apresTarif.jsp&acte=validerPayerEtLivrer&id=" + request.getParameter("id") + "&bute=vente/vente-liste.jsp&classe=" + classe%> "
                               style="margin-right: 10px">Viser, payer et livrer</a>
                            <a class="pull-left btn btn-danger"
                               href="<%= lien + "?but=apresTarif.jsp&id=" + id + "&acte=annuler&bute=vente/fiche-vente-retour-payment.jsp&classe=" + classe%>">Annuler</a>
                            <% } %>
                            <%
                                if (dp.getEtat() >= ConstanteEtat.getEtatValider()) { %>
                            <a class="btn btn-primary pull-right"
            ...
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    <li class="<%=map.get("encaissement-vise-liste")%>"><a
                            href="<%= lien%>?but=<%= pageActuel%>&id=<%= request.getParameter("idVente") %>&tab=encaissement-vise-liste">Paiement(s)</a>
                    </li>
