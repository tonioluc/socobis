...
<%@ page import="vente.stat.VenteParClient" %>
...
<% try{
    ...
    VenteParClient t = new VenteParClient();
    String listeCrt[] = {"client","qte_totale","montant_ht", "montant_tva", "montant_ttc", "montant_remise", "poids_total", "frais_total","mois","annee"};
    ...
    String libEntete[] = new String[]{"client","qte_totale","montant_ht", "montant_tva", "montant_ttc", "montant_remise", "poids_total", "frais_total","mois","annee"};
    ...
    String libEnteteAffiche[] = new String[]{"Client","Quantit&eacute;","Montant HT","Montant TVA","Montant TTC","Montant Remise","Poids","Frais","Mois","Ann&eacute;e"};
...
<div class="content-wrapper">
    <section class="content-header">
        <h1>Statistique de Vente par Client</h1>
    </section>
