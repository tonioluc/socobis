...
<%@ page import="vente.stat.VenteParFamille" %>
...
<% try{
    ...
    VenteParFamille t = new VenteParFamille();
    String listeCrt[] = {"familleproduitlib","qte_totale","montant_ht", "montant_tva", "montant_ttc", "montant_remise", "poids_total", "frais_total","mois","annee"};
    ...
    String libEntete[] = new String[]{"idfamille","familleproduitlib","qte_totale","montant_ht", "montant_tva", "montant_ttc", "montant_remise", "poids_total", "frais_total","mois","annee"};
    ...
    pr.getFormu().getChamp("familleproduitlib").setLibelle("Famille");
    ...
    String colonneLien[] = {"idfamille"};
    String[] attributLien = {"id"};
    String colonneModal[] = {"idfamille"};
    ...
    String libEnteteAffiche[] = new String[]{"ID","Famille","Quantit&eacute;","Montant HT","Montant TVA","Montant TTC","Montant Remise","Poids","Frais","Mois","Ann&eacute;e"};
