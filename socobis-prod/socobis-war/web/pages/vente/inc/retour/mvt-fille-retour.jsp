...
<%
    try{
        ...
        if(request.getParameter("id") != null){
            ...
            MvtStockLib mvtStockLib = new MvtStockLib();
            mvtStockLib.setIdobjet(request.getParameter("id"));
            MvtStockLib[]mvtStockList =  (MvtStockLib[]) CGenUtil.rechercher(mvtStockLib,null,null,null,"");
            if (mvtStockList.length>0){
                pr.setAWhere(" and idmvtstock='" + mvtStockList[0].getId() + "'");
            }
