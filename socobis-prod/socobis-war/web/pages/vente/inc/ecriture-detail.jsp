...
<%
    ...
    String listeCrt[] = {};
    String listeInt[] = {};
    String libEntete[] =  {"id", "numero","journal", "compte","compte_aux","daty","remarque", "debit", "credit"};
...
<div class="box-body">
    <%
         String libEnteteAffiche[] =  {"ID", "Libell&eacute; de compte","Journal",  "Compte","Compte Auxiliaire","Date","Remarque",  "D&eacute;bit", "Cr&eacute;dit"};
