                    ...
                    <div class="box-body">
                        ...
                        <div class="box-footer">
                            ...
                            <a class="btn btn-primary pull-right"
                               href="<%= (String) session.getValue("lien") + "?but=apresTarif.jsp&acte=validerEtPayer&id=" + request.getParameter("id") + "&bute=vente/vente-liste.jsp&classe=" + classe%> "
                               style="margin-right: 10px">Viser et payer</a>
