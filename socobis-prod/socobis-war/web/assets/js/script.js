...
function pagePopUp(page,name=""){
     console.log("La page: ",page,width=1009,height=532);
     window.open(page,name,"titulaireresizable=no,scrollbars=yes,location=no,width="+width+",height="+height+",top=0,left=0");
}
