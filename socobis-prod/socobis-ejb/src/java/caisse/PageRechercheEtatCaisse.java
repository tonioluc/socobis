...
public class PageRechercheEtatCaisse extends PageRecherche{

    Date dateMin;
    Date  dateMax;
    boolean isSimpleSearch= false;

    public PageRechercheEtatCaisse(ClassMAPTable o, HttpServletRequest req, String[] vrt, String[] listInterval, int nbRange, String[] tabAff, int nbAff) throws Exception {
   ...
   public  boolean processDateParameter(String dateMin, String dateMax) {
    ...
    public void preparerDataList(Connection c) throws Exception {
        EtatCaisse etatCaisse=(EtatCaisse)this.getCritere();
        etatCaisse.setNomTable(getBase().getNomTable());
        this.makeCritere();
        if (getPremier() == true) {
