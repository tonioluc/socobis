 ...
 * @author Angela
 */
public class PageRechercheChoixEtatStock extends PageRechercheChoix {
    
    Date dateMin;
    Date  dateMax;
    boolean isSimpleSearch;

    public PageRechercheChoixEtatStock(ClassMAPTable o, HttpServletRequest req, String[] vrt, String[] listInterval, int nbRange, String[] tabAff, int nbAff) throws Exception {
